...
#if !CONFIG_SOC_ATMEL_SAMD1_OSC32K || CONFIG_SOC_ATMEL_SAMD1_DEFAULT_AS_MAIN
#define osc32k_init()
#else
...
#if !CONFIG_SOC_ATMEL_SAMD1_XOSC || CONFIG_SOC_ATMEL_SAMD1_DEFAULT_AS_MAIN
#define xosc_init()
#else
static inline void xosc_init(void)
{
	SYSCTRL->XOSC.reg = SYSCTRL_XOSC_STARTUP(0x5) /* 32 cycles / ~1ms */
			  ...
			  | SYSCTRL_XOSC_AMPGC
#if CONFIG_SOC_ATMEL_SAMD1_XOSC_FREQ_HZ <= 2000000
			  | SYSCTRL_XOSC_GAIN(0x0)
#elif CONFIG_SOC_ATMEL_SAMD1_XOSC_FREQ_HZ <= 4000000
			  | SYSCTRL_XOSC_GAIN(0x1)
#elif CONFIG_SOC_ATMEL_SAMD1_XOSC_FREQ_HZ <= 8000000
			  | SYSCTRL_XOSC_GAIN(0x2)
#elif CONFIG_SOC_ATMEL_SAMD1_XOSC_FREQ_HZ <= 16000000
			  | SYSCTRL_XOSC_GAIN(0x3)
#elif CONFIG_SOC_ATMEL_SAMD1_XOSC_FREQ_HZ <= 32000000
			  | SYSCTRL_XOSC_GAIN(0x4)
#endif
#if CONFIG_SOC_ATMEL_SAMD1_XOSC_CRYSTAL
			  | SYSCTRL_XOSC_XTALEN
#endif
			  | SYSCTRL_XOSC_ENABLE;
...
#if !CONFIG_SOC_ATMEL_SAMD1_XOSC32K || CONFIG_SOC_ATMEL_SAMD1_DEFAULT_AS_MAIN
#define xosc32k_init()
#else
...
#if CONFIG_SOC_ATMEL_SAMD1_XOSC32K_CRYSTAL
...
#if CONFIG_SOC_ATMEL_SAMD1_DEFAULT_AS_MAIN
#define dfll48m_init()
#else
...
#if CONFIG_SOC_ATMEL_SAMD1_OSC32K_AS_MAIN
			  | GCLK_GENCTRL_SRC_OSC32K
#elif CONFIG_SOC_ATMEL_SAMD1_XOSC32K_AS_MAIN
			  | GCLK_GENCTRL_SRC_XOSC32K
#elif CONFIG_SOC_ATMEL_SAMD1_OSC8M_AS_MAIN
			  | GCLK_GENCTRL_SRC_OSC8M
#elif CONFIG_SOC_ATMEL_SAMD1_XOSC_AS_MAIN
...
{
	NVMCTRL->CTRLB.bit.RWS = NVMCTRL_CTRLB_RWS(CONFIG_SOC_ATMEL_SAMD1_NVM_WAIT_STATES);
}
#endif
...
#if !CONFIG_ADC_SAM0 || CONFIG_SOC_ATMEL_SAMD1_DEFAULT_AS_MAIN
...
#if CONFIG_SOC_ATMEL_SAMD1_OSC8M || CONFIG_SOC_ATMEL_SAMD1_DEFAULT_AS_MAIN
